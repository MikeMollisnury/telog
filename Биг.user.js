...
const buttons = [
	...
	},
    {
	  title: '| Не по форме |',
	  content:
		'[CENTER][url=https://postimg.cc/Zv8wvJwR][img]https://i.postimg.cc/nr5g5z7v/image.png[/img][/url]<br>' +
		...
		"[B][CENTER][FONT=Vetka] Твой текст[/FONT][/COLOR][/CENTER][/B]<br><br>"+
        "[B][CENTER][FONT=Verdana] Твой текст[/FONT][/COLOR][/CENTER][/B]<br><br>"+
